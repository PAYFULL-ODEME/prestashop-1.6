...
class PayfullProcess3DModuleFrontController extends ModuleFrontController
{
    ...
    public function initContent()
    {
        ...
        try {
            ...
            if(PayfullApi::processPayResponse($this->module, $response, true)) {
            ...
            if($log_id) {
                Db::getInstance()->update('payfull_transaction', ['status' => 0], 'id = ' . $log_id);
            }
    ...
    protected function _redirectToConfirmation($order, $message)
    {
        ...
        $returnUrl = $this->context->link->getModuleLink('payfull', 'confirmation', $params, true);
